...
export function OrderDetailClient() {
  ...
  const invalidRef = !orderRef || isForbiddenOrderRef(orderRef);
  ...
  const loadOrder = useCallback(
    ...
    [invalidRef, orderRef, router, t.orders.notFound, t.orders.unavailable]
  );
        ...
        <FadeIn>
          ...
          {invalidRef ? (
            <div className="rounded-2xl border border-white/10 bg-layali-surface p-8 text-center">
              <p className="text-white mb-4">{t.orders.notFound}</p>
