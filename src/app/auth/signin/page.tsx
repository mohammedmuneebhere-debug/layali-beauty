    ...
    <div className="min-h-screen bg-transparent flex items-center justify-center py-12 px-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          <Link href="/">
            <h1 className="font-serif text-4xl font-semibold tracking-[0.28em] text-white">LAYALI</h1>
          </Link>
          <p className="font-script text-2xl text-layali-pink mt-2">welcome back</p>
        </div>

        <div className="glass-panel rounded-3xl p-8">
          <h2 className="font-serif text-2xl font-medium text-white mb-6 text-center">Sign In</h2>
